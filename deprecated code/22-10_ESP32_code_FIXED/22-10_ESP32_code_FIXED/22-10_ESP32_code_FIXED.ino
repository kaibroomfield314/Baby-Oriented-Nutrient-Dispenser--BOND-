...
#define BTN_2 14        // D14
#define BTN_3 27        // D27
#define BTN_4 39        // D39 - FIXED: Changed from 36 (VP) to 39 (VN) to avoid conflict with ENCODER_C1
#define BTN_5 33        // D33
...
void setup() {
    ...
    pinMode(BTN_4, INPUT_PULLUP);  // Now properly configured
    ...
    pAdvertising->setMaxPreferred(0x12);  // FIXED: Changed from setMinPreferred to setMaxPreferred
...
void moveToCompartment(int compartment) {
    ...
    float targetAngle = (compartment - 1) * ANGLE_PER_COMPARTMENT;
